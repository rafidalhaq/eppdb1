                      ...
                      <div class="callout callout-info">
                        <p><?php echo $formulir->ketentuan ?></p>
                          ...
                          <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nisn" id="nisn" placeholder="NISN harus tepat 10 karakter" value="" required/>
                          </div>
                          <?php } ?>
                ...
                <!-- star nilai -->
                      <?php if ($formulir->nilai_usbn=='Ya' || $formulir->nilai_rapor=='Ya' || $formulir->nilai_unbk_unkp=='Ya'){ ?> 
                          ...
                          <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nilai_rapor" id="nilai_rapor" placeholder="Nilai Rata-rata Rapor yang terdapat pada SKL/SKHU/Ijazah" />
                          </div>
                          <?php } else { ?>
                          ...
                          <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nilai_usbn" id="nilai_usbn" placeholder="Nilai Rata-rata USBN yang terdapat pada SKL/SKHU/Ijazah" />
                          </div>
                          <?php } else { ?>
                          ...
                          <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nilai_unbk_unkp" id="nilai_unbk_unkp" placeholder="Nilai Rata-rata UN yang terdapat pada SKL/SKHU/Ijazah" />
                          </div>
                          <?php } else { ?>
