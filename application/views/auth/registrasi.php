    ...
    <div class="container-login ">
      ...
      <?php echo form_open("auth/proses_registrasi");?>
        ...
        <div class="form-group has-feedback">
          ...
          <input type="text" id="username" data-toggle="username" name="username" class="form-control" placeholder="<?php echo lang('create_user_username_label1') ?>" value="<?php echo set_value('username');?>" autofocus required />
        </div>
